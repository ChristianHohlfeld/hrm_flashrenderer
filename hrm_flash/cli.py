...
def main():
    ...
    s.add_argument("--model_quant", type=str, choices=["q8"], default="q8", help="Native model quantization mode (q8 only)")
    s.add_argument("--model_bin", type=str, default=None, help="Native DeepSeek model bin path (q8)")
    ...
    g.add_argument("--model_quant", type=str, choices=["q8"], default="q8", help="Native model quantization mode (q8 only)")
    g.add_argument("--model_bin", type=str, default=None, help="Native DeepSeek model bin path (q8)")
