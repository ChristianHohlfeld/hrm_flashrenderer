...
class TestNativeProdRegressions(unittest.TestCase):
    ...
    def test_three_modes_are_wired_in_mainline(self):
        ...
        self.assertIn('"mode": mode,', serve_txt)
        self.assertIn('"hrm_active": hrm_active,', serve_txt)
        self.assertIn('"audit": {', serve_txt)
        self.assertIn('"hrm_called": bool(hrm_active),', serve_txt)
        ...
        self.assertIn('def _resolve_show_sources(show_sources: Optional[bool], mode: str) -> bool:', router_txt)
